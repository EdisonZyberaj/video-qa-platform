					...
					: error
						...
						: <div>
								...
								<div className="mb-6 border border-lightBlue rounded-lg p-4 bg-white">
									...
									<p className="text-sm text-gray-600 mb-4">
										You can upload one video to accompany all your answers for
										this survey.
									</p>
								...
								<button
									...
									className={`${submitting
										? "bg-gray-400"
										: "bg-mediumBlue hover:bg-hoverBlue"} text-white font-medium py-3 px-8 rounded-full shadow-md hover:shadow-lg transition-all duration-300 mt-6 flex items-center justify-center w-full`}>
									{submitting
